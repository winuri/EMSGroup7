...
ALTER TABLE `inventory`
MODIFY COLUMN `Category_ID` varchar(20) DEFAULT NULL;



-- Step 2: Add Category_ID column to inventory table
ALTER TABLE `inventory`
ADD CONSTRAINT `inventory_ibfk_2` FOREIGN KEY (`Category_ID`) REFERENCES `categories` (`Category_ID`);
...
-- UPDATE `inventory` SET `Category_ID` =' 3' WHERE `Tool_ID` = 2;
