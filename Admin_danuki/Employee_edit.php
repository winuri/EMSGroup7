                ...
                <section>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                            <input type="text" class="form-control" name="Member_No" value= "<?php echo $row['Member_No']?>">
                            </div>
                        </div><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <select class="form-select"  name="Position_name" aria-label="position selection" >
                                    ...
                                    <option value="<?php echo $cc['Position_ID'] ?>" <?php if($cc['Position_name'] == $row['Position_name']) echo 'selected'; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" aria-label="First name" name="F_name" value="<?php echo $row['F_name']?>">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" aria-label="Last name" name="L_name" value="<?php echo $row['L_name']?>" >
                            </div>
                        </div><br><br>
                        ...
                        <div class="row">
                            ...
                            <input type="date" class="form-control" posiname="inputDOB" name="DOB"  value="<?php echo $row['DOB'] ?>">
                            </div>
                        </div><br><br>
                        ...
                        <legend class="col-form-label col-sm-2 pt-0">Account Number:</legend>
                            <div class="col">
                                <input type="text" class="form-control" aria-label="Account Number" name="Acc_No" value="<?php echo $row['Acc_No'] ?>" >
                            </div>
                            <div class="col">
