...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 27, 2024 at 09:29 AM
...
(1, 201, 'K.G.H', 'Ramyalatha', '746211520V', 76359658, 'Female', 'Mathale', '1974-02-02', NULL, NULL, NULL, NULL),
(2, 93, 'B.D', 'Abekon Banda', '196723501570', 712365698, 'Male', 'Kurunegala', '1967-03-03', NULL, NULL, NULL, NULL),
...
(9, 320, 'Wimal', 'K.D', '199825631254', 774564251, 'Male', 'Trincomalee', '1998-01-02', NULL, NULL, NULL, NULL),
(10, 321, 'Wimala', 'K.D.h', '199825631253', 774564522, 'Female', 'Trincomalee', '1999-05-06', 1, 8, 2, 10),
...
CREATE TABLE IF NOT EXISTS `paymethod` (
  `Pay_ID` int NOT NULL,
  `Pay_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`Pay_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `workplace` (
  ...
  `Work_Address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Work_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
