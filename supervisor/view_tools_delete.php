...
<div class="content">
    <h1 class="my-4">Tools in Category: <?php echo htmlspecialchars($categoryName); ?></h1>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === 'success') {
                            ...
                            alert('Error deleting tool: ' + response); // Show error message if deletion fails
                        }
                    },
                    error: function(xhr, status, error) {
                        console.error('Error deleting tool:', error); // Log detailed error message
                    }
                });
            }
        });
